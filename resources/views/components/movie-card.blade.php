<a href="./movie/{{$movie['id']}}" class="hover:text-gray-300 w-60">
    <div class="w-64 h-96 relative">
        <img src="https://image.tmdb.org/t/p/w300{{$movie['poster_path']}}" alt="Poster de {{$movie['title']}}" class="hover:opacity-75 transition ease-in-out duration-150 w-full h-full object-cover">
    </div>
