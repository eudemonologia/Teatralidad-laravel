<div class="modalVideo fixed top-0 h-screen w-full justify-center items-center bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-60 border border-gray-200 hidden">
